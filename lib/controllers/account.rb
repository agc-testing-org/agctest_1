    ...
    def mail_invite token
        ...
        if on_team
            if invite.profile_id # profile share
                ...
                link = "#{ENV['INTEGRATIONS_HOST']}/develop/roadmap/job/#{invite.job_id}-#{invite.job.title}-for-#{invite.job.team}-at-#{invite.job.company}/#{invite.token}"
                return mail invite.user_email, "#{invite.team.company} has shared a Wired7 job listing with you", "#{invite.user.first_name},<br><br>#{invite.sender.first_name} (#{invite.sender.email}) on the #{invite.team.name} team at #{invite.team.company} would like for you to check out a job listing for #{invite.job.title} at #{invite.job.company}.  Please use the following link to get your foot in the door:<br><br><a href='#{link}'>#{link}</a><br><br><br>- The Wired7 ATeam", "#{invite.user.first_name},\n\n#{invite.sender.first_name} (#{invite.sender.email}) on the #{invite.team.name} team at #{invite.team.company} would like for you to check out a job listing for #{invite.job.title} at #{invite.job.company}.  Please use the following link to get your foot in the door:\n\n#{link}\n\n\n- The Wired7 ATeam"
            end
            ...
            if invite.profile_id
                ...
                return mail invite.user_email, "#{invite.team.company} has shared a Wired7 job listing with you", "Great news,<br><br>#{invite.sender.first_name} (#{invite.sender.email}) on the #{invite.team.name} team at #{invite.team.company} would like for you to check out a job listing for #{invite.job.title} at #{invite.job.company} on Wired7!<br><br>To accept this invitation please use the following link:<br><br><a href='#{link}'>#{link}</a><br><br>This link is valid for 24 hours.<br><br><br>- The Wired7 ATeam", "Great news,\n\n#{invite.sender.first_name} (#{invite.sender.email}) on the #{invite.team.name} team at #{invite.team.company} would like for you to check out a job listing for #{invite.job.title} at #{invite.job.company} on Wired7!\n\nTo accept this invitation please use the following link:\n\n#{link}\n\nThis link is valid for 24 hours.\n\n\n- The Wired7 ATeam"
            else
