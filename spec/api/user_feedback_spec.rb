    ...
    context "user_id" do
      context "valid params" do
        ...
        context "filter by" do
          context "skillset_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-comments?skillset_id=#{@skillset_id}"
          ...
          context "role_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-comments?role_id=#{@role_id}"
              @feedback = JSON.parse(last_response.body)
          ...
          context "skillset_id&role_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-comments?skillset_id=#{@skillset_id}&role_id=#{@role_id}"
              @feedback = JSON.parse(last_response.body)
      ...
      context "me" do
        context "unauthorized" do
          context "skillset" do
            before(:each) do
              get "/users/me/aggregate-comments?skillset_id=#{@skillset_id}"
            end
            it_behaves_like "unauthorized"
          end
          context "role" do
            before(:each) do
              get "/users/me/aggregate-comments?role_id=#{@role_id}"
            end
            it_behaves_like "unauthorized"
          end
          context "skillset&role" do
            before(:each) do
              get "/users/me/aggregate-comments?skillset_id=#{@skillset_id}&role_id=#{@role_id}"
            end
            it_behaves_like "unauthorized"
          end
        end
    ...
    context "user_id" do
      context "valid params" do
        ...
        context "filter by" do
          context "skillset_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-votes?skillset_id=#{@skillset_id}"
              @feedback = JSON.parse(last_response.body)
          ...
          context "role_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-votes?role_id=#{@role_id}"
              @feedback = JSON.parse(last_response.body)
          ...
          context "skillset_id&role_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-votes?skillset_id=#{@skillset_id}&role_id=#{@role_id}"
              @feedback = JSON.parse(last_response.body)
      ...
      context "me" do
        context "unauthorized" do
          context "skillset" do
            before(:each) do
              get "/users/me/aggregate-votes?skillset_id=#{@skillset_id}"
            end
            it_behaves_like "unauthorized"
          end
          context "role" do
            before(:each) do
              get "/users/me/aggregate-votes?role_id=#{@role_id}"
            end
            it_behaves_like "unauthorized"
          end
          context "skillset&role" do
            before(:each) do
              get "/users/me/aggregate-votes?skillset_id=#{@skillset_id}&role_id=#{@role_id}"
            end
            it_behaves_like "unauthorized"
          end
        end
  ...
  describe "GET /aggregate-contributors" do
    ...
    context "user_id" do
      context "valid params" do
        ...
        context "filter by" do
          context "skillset_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-contributors?skillset_id=#{@skillset_id}"
              @feedback = JSON.parse(last_response.body)
          ...
          context "role_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-contributors?role_id=#{@role_id}"
              @feedback = JSON.parse(last_response.body)
          ...
          context "skillset_id&role_id" do
            before(:each) do
              get "/users/#{@user_id}/aggregate-contributors?skillset_id=#{@skillset_id}&role_id=#{@role_id}"
              @feedback = JSON.parse(last_response.body)
    ...
    context "me" do
      context "unauthorized" do
        context "skillset" do
          before(:each) do
            get "/users/me/aggregate-contributors?skillset_id=#{@skillset_id}"
          end
          it_behaves_like "unauthorized"
        end
        context "role" do
          before(:each) do
            get "/users/me/aggregate-contributors?role_id=#{@role_id}"
          end
          it_behaves_like "unauthorized"
        end
        context "skillset&role" do
          before(:each) do
            get "/users/me/aggregate-contributors?skillset_id=#{@skillset_id}&role_id=#{@role_id}"
          end
          it_behaves_like "unauthorized"
        end
      end
